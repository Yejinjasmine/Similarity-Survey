...
st.set_page_config(page_title="행동 문장 유사도 설문", layout="wide")
...
# 파일 경로
PAIR_FILE = "Set_2_Behavior_Pairs.csv"
...
# 3단계: 설명 및 동의
    ...
    explanations = [
        "총 **46개의 문장**으로 구성된 **435쌍 (=30 x 29 / 2)**의 문장쌍을 평가합니다.",
        ...
        "두 문장이 내용적으로 유사하다고 생각되는 만큼 점수를 평가하면 됩니다. 문장 유사도는 주관적으로 판단하는 것이므로 정해진 정답이 없습니다. 예시:\n'사자는 매우 용맹한 동물이다.' vs '호랑이는 매우 용감한 동물이다.' → \"5점\" 또는 \"3점\" \"2점\" 등 평가 가능.",
